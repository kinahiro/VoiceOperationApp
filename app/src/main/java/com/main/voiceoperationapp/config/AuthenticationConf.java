...
public class AuthenticationConf {
    ...
    public AuthenticationConf(Config conf) {
        clientId = conf.getString("clientId");
        clientSecret = conf.getString("clientSecret");
        scope = conf.getString("scope");
        codeRedirectUri = conf.getString("codeRedirectUri");
        googleOAuthEndpoint = conf.getString("googleOAuthEndpoint");
        urlGoogleAccount = conf.getString("urlGoogleAccount");
        credentialsFilePath = conf.getString("credentialsFilePath");
        maxDelayBeforeRefresh = conf.getLong("maxDelayBeforeRefresh");
    }

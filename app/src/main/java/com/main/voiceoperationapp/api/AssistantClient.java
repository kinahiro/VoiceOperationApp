package com.main.voiceoperationapp.api;
...
import com.main.voiceoperationapp.authentication.OAuthCredentials;
import com.main.voiceoperationapp.config.AssistantConf;
import com.main.voiceoperationapp.config.IoConf;
import com.main.voiceoperationapp.device.Device;
import com.main.voiceoperationapp.device.DeviceModel;
...
public class AssistantClient implements StreamObserver<AssistResponse> {
    ...
    public void requestAssistant(byte[] request) throws ConverseException {
        switch (ioConf.getInputMode()) {
            ...
            case IoConf.TEXT:
                ...
                break;
            default:
                Log.e(TAG,"Unknown input mode {"+ ioConf.getInputMode() +"}");
        }
    }
    ...
    private byte[] textRequestAssistant(byte[] request) throws ConverseException {
        ...
        try {
            ...
            Log.i(TAG,"Requesting the assistant");
    ...
    public void onNext(AssistResponse value) {
        try {
            if (value.getEventType() != null
                ...
                Log.i(TAG,"Event type : {"+ value.getEventType().name() +"}");
            }
            ...
            if (value.getDialogStateOut() != null) {
                ...
                if (value.getSpeechResultsList() != null) {
                    ...
                    if (!userRequest.isEmpty()) {
                        Log.i(TAG,"Request Text : {"+ userRequest +"}");
                    }
                }
            }
            ...
            Log.w(TAG,"Error requesting the assistant : " + e);
        }
    }

    @Override
    public void onError(Throwable t) {
        Log.w(TAG,"Error requesting the assistant : " + t);
        finishLatch.countDown();
    }

    @Override
    public void onCompleted() {
        Log.i(TAG,"End of the response");
        finishLatch.countDown();
    }

...
@javax.annotation.Generated(
    ...
    comments = "Source: embedded_assistant.proto")
public final class EmbeddedAssistantGrpc {
  ...
  @java.lang.Deprecated // Use {@link #getAssistMethod()} instead. 
  public static final io.grpc.MethodDescriptor<com.google.assistant.embedded.v1alpha2.AssistRequest,
      com.google.assistant.embedded.v1alpha2.AssistResponse> METHOD_ASSIST = getAssistMethod();

  private static volatile io.grpc.MethodDescriptor<com.google.assistant.embedded.v1alpha2.AssistRequest,
      com.google.assistant.embedded.v1alpha2.AssistResponse> getAssistMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<com.google.assistant.embedded.v1alpha2.AssistRequest,
      com.google.assistant.embedded.v1alpha2.AssistResponse> getAssistMethod() {
    io.grpc.MethodDescriptor<com.google.assistant.embedded.v1alpha2.AssistRequest, com.google.assistant.embedded.v1alpha2.AssistResponse> getAssistMethod;
    if ((getAssistMethod = EmbeddedAssistantGrpc.getAssistMethod) == null) {
      synchronized (EmbeddedAssistantGrpc.class) {
        if ((getAssistMethod = EmbeddedAssistantGrpc.getAssistMethod) == null) {
          EmbeddedAssistantGrpc.getAssistMethod = getAssistMethod = 
              io.grpc.MethodDescriptor.<com.google.assistant.embedded.v1alpha2.AssistRequest, com.google.assistant.embedded.v1alpha2.AssistResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "google.assistant.embedded.v1alpha2.EmbeddedAssistant", "Assist"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.assistant.embedded.v1alpha2.AssistRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.assistant.embedded.v1alpha2.AssistResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new EmbeddedAssistantMethodDescriptorSupplier("Assist"))
                  .build();
          }
        }
     }
     return getAssistMethod;
  }
  ...
  public static abstract class EmbeddedAssistantImplBase implements io.grpc.BindableService {
    ...
    public io.grpc.stub.StreamObserver<com.google.assistant.embedded.v1alpha2.AssistRequest> assist(
      ...
      return asyncUnimplementedStreamingCall(getAssistMethod(), responseObserver);
    }
  ...
  public static final class EmbeddedAssistantStub extends io.grpc.stub.AbstractStub<EmbeddedAssistantStub> {
    ...
    public io.grpc.stub.StreamObserver<com.google.assistant.embedded.v1alpha2.AssistRequest> assist(
      ...
      return asyncBidiStreamingCall(
          getChannel().newCall(getAssistMethod(), getCallOptions()), responseObserver);
    }
  }
  ...
  private static abstract class EmbeddedAssistantBaseDescriptorSupplier
  ...
  private static final class EmbeddedAssistantFileDescriptorSupplier
      extends EmbeddedAssistantBaseDescriptorSupplier {
    EmbeddedAssistantFileDescriptorSupplier() {}
  }

  private static final class EmbeddedAssistantMethodDescriptorSupplier
      extends EmbeddedAssistantBaseDescriptorSupplier
      implements io.grpc.protobuf.ProtoMethodDescriptorSupplier {
    private final String methodName;

    EmbeddedAssistantMethodDescriptorSupplier(String methodName) {
      ...
      synchronized (EmbeddedAssistantGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new EmbeddedAssistantFileDescriptorSupplier())
              .addMethod(getAssistMethod())
              .build();
        }
      }
    }
